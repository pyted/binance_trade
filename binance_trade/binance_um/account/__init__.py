...
class AccountUM():
    ...
    def get_balances(self, recvWindow: int = ''):
        ...
        '''
        return self.inst.accountTrade.get_balance(**to_local(locals()))
    ...
    def set_leverage(
        ...
        '''
        return self.inst.accountTrade.set_leverage(**to_local(locals()))
    ...
    def set_marginType(
        ...
        '''
        result = self.inst.accountTrade.set_marginType(**to_local(locals()))
